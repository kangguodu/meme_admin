...
//                    'yellow',
//                    '',
//                    RebateOrder::where('cycle_status', 2)->sum('interest_ever')
//                ));
//                $row->column(3, new InfoBox(
//                    '剩餘回贈蜂幣',
//                    'dollar',
//                    'red',
//                    '',
//                    RebateOrder::whereIn('cycle_status', [1, 2])->sum('interest_remain')
//                ));
                $row->column(6, function (Column $column){
                    ...
                    $box = "<div class='row'><div class='col-sm-6'>{$info1}</div>";
                    $box .= "<div class='col-sm-6'>{$info2}</div></div>";
                    $column->append($box);

//                    $column->append(new Box('會員數量成長', new Bar(
//                        array_fill(0, 31, 'index'),
//                        [
//                            ['First', array_fill(0, 31, 15), 'red'],
//                        ]
//                    )));
                });
//                $row->column(6, function (Column $column){
//                    $column->append(new Box('蜂幣回贈成長圖', new Bar(
//                        array_fill(0, 31, 'index'),
//                        [
//                            ['First', array_fill(0, 31, 15), 'red'],
//                        ]
